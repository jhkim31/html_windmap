...
kakao.maps.event.addListener(map, 'dragend', () => {
    var po = new kakao.maps.LatLng(map.getCenter().Ma, map.getCenter().La)
    console.log(coordinate.containerPointFromCoords(po))
    var showData = countAppearStation();
    run2(showData)
})
...
TemperatureMap.prototype.setCoordsPoints = function (data, width, height) {
...
var run = function () {
    ...
    var drw1 = new TemperatureMap(ctx1)



    drw1.setRandomPoints(50, width, height);
    drw1.drawLow(10, 10, false, function () { drw1.drawPoints(); });
...
var run2 = function (data) {
    ...
    drw1.setCoordsPoints(data, width, height);
    drw1.drawLow(10, 5, false, function () { drw1.drawPoints(); });
    // drw1.drawFull(false, function () { drw1.drawPoints(); });
}
